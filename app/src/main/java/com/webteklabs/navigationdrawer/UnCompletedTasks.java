 ...
 */
public class UnCompletedTasks extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_un_completed_tasks, container, false);
    }
    ...
    public void onResume() {
        ...
        try {
            ...
            Toast.makeText(getActivity(), "Uncompleted Tasks ", Toast.LENGTH_LONG).show();
